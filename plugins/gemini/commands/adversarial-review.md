...
Run an adversarial Gemini review against local git changes.
...
- After launching the command, tell the user: "Gemini adversarial review started in the background. You'll be notified when it completes."
